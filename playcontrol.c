...
void procgamecontrol(void)
{
	...
	if (endlevel==0)
		...
		else
		{
			...
			{
				if (firstperson==0)
					if (button[4]>0) {if (playeraim==0) zcplaysound3d(16,5,mob[mobcontrol][1],mob[mobcontrol][2],mob[mobcontrol][3]+65536); playeraim=16;} else if (playeraim>0)
						playeraim--;
