		...
		for (y=cy0; y<cy1; y++)
			for (x=cx0; x<cx1; x++)
				if (mp[x][y][z][1]>0)
					switch (mp[x][y][z][1])
					{
					case 8: newlight((x<<16)+32768,(y<<16)+32768,(z<<16)+32768,(255)+(255<<8)+(255<<16)+(2<<24));
						break;                                            //white light
					case 9: newlight((x<<16)+32768,(y<<16)+32768,(z<<16)+32768,(255)+(0<<8)+(0<<16)+(2<<24));
						break;                                        // light
					case 10: newlight((x<<16)+32768,(y<<16)+32768,(z<<16)+32768,(0)+(255<<8)+(0<<16)+(2<<24));
						break;                                         // light
					case 11: newlight((x<<16)+32768,(y<<16)+32768,(z<<16)+32768,(0)+(0<<8)+(255<<16)+(2<<24));
						break;                                         // light
					case 12: newlight((x<<16)+32768,(y<<16)+32768,(z<<16)+32768,(255)+(255<<8)+(0<<16)+(2<<24));
						break;                                           // light
					case 13: newlight((x<<16)+32768,(y<<16)+32768,(z<<16)+32768,(0)+(255<<8)+(255<<16)+(2<<24));
						break;                                           // light
					case 14: newlight((x<<16)+32768,(y<<16)+32768,(z<<16)+32768,(255)+(0<<8)+(255<<16)+(2<<24));
						break;                                           // light
					case 15:
				...
				for (x=cx0; x<cx1; x++)
					if (intrestingmp[x][y][z])
					{
						...
						if (cert[ix][iy][iz])
						{
							...
							if (scert[ix][iy][iz+1]==0 && scert[ix+1][iy][iz+1]==0 && scert[ix][iy+1][iz+1]==0 && scert[ix+1][iy+1][iz+1]==0)
								renderit=0;
							else
/*
...
//zlDrawFromIndice(6);
							...
							if (scert[ix][iy][iz]==0 && scert[ix+1][iy][iz]==0 && scert[ix][iy+1][iz]==0 && scert[ix+1][iy+1][iz]==0)
								renderit=0;
							else
/*
 ...
 */
							...
							if (scert[ix][iy+1][iz]==0 && scert[ix+1][iy+1][iz]==0 && scert[ix+1][iy+1][iz+1]==0 && scert[ix][iy+1][iz+1]==0)
								renderit=0;
							else
/*
   if (prec[ix][iy+1][iz]==0) renderit=0;else
 ...
 */
							...
							if (scert[ix][iy][iz]==0 && scert[ix+1][iy][iz]==0 && scert[ix+1][iy][iz+1]==0 && scert[ix][iy][iz+1]==0)
								renderit=0;
							else
/*
   if (prec[ix][iy][iz]==0) renderit=0;else
 ...
 */
							...
							if (scert[ix][iy][iz]==0 && scert[ix][iy+1][iz]==0 && scert[ix][iy+1][iz+1]==0 && scert[ix][iy][iz+1]==0)
								renderit=0;
							else
/*
   if (prec[ix][iy+1][iz]==0) renderit=0;else
 ...
 */
							...
							if (scert[ix+1][iy][iz]==0 && scert[ix+1][iy+1][iz]==0 && scert[ix+1][iy+1][iz+1]==0 && scert[ix+1][iy][iz+1]==0)
								renderit=0;
							else
/*
   if (prec[ix+1][iy][iz]==0) renderit=0;else
		...
		if (mob[i][0]>0)
			if (mob[i][41]>0 | i==mobcontrol)
			{
				...
				case 0://player
					...
					break;
				case 2: newlight(mob[i][1],mob[i][2],mob[i][3]+32768,(32)+(255<<8)+(32<<16)+(1<<24));
					break;                                            //slime
				case 5: newlight(mob[i][1],mob[i][2],mob[i][3]+65536,(255)+(255<<8)+(32<<16)+(1<<24));
					break;                                             //ghoul
				}
			}
}
