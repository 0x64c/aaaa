...
u8 moblive[17]={
	3,1,1,1,2, 3,1,10,1, 1,1,1,1, 1,1,1,1
};
...
//z
	if (mob[i][6]!=0)
	{
		...
		{//iz>0
			...
			if (mpb[xx0[0]>>16][yy0[0]>>16][zz[1]>>16]>0)
				blockz=1;
			else
			if (mpb[xx0[1]>>16][yy0[0]>>16][zz[1]>>16]>0)
				blockz=1;
			else
			if (mpb[xx0[1]>>16][yy0[1]>>16][zz[1]>>16]>0)
				blockz=1;
			else
			if (mpb[xx0[0]>>16][yy0[1]>>16][zz[1]>>16]>0)
				blockz=1;
		}
		else
		{//iz<0
			if (zz[0]<0) {blockz=1; killmob(i);}else
			if (mpb[xx0[0]>>16][yy0[0]>>16][zz[0]>>16]>0)
				blockz=1;
			else
			if (mpb[xx0[1]>>16][yy0[0]>>16][zz[0]>>16]>0)
				blockz=1;
			else
			if (mpb[xx0[1]>>16][yy0[1]>>16][zz[0]>>16]>0)
				blockz=1;
			else
			if (mpb[xx0[0]>>16][yy0[1]>>16][zz[0]>>16]>0)
				blockz=1;
...
//x
	if (mob[i][4]!=0)
	{
		...
		{//ix>0
			...
			if (mpb[xx[1]>>16][yy0[0]>>16][zz0[0]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[1]>>16][yy0[1]>>16][zz0[0]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[1]>>16][yy0[0]>>16][zz0[1]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[1]>>16][yy0[1]>>16][zz0[1]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[1]>>16][yy0[0]>>16][zz0[2]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[1]>>16][yy0[1]>>16][zz0[2]>>16]>0)
				blockx=1;
		}
		else
		{//ix<0
			if (xx[0]<0) blockx=1; else
			if (mpb[xx[0]>>16][yy0[0]>>16][zz0[0]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[0]>>16][yy0[1]>>16][zz0[0]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[0]>>16][yy0[0]>>16][zz0[1]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[0]>>16][yy0[1]>>16][zz0[1]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[0]>>16][yy0[0]>>16][zz0[2]>>16]>0)
				blockx=1;
			else
			if (mpb[xx[0]>>16][yy0[1]>>16][zz0[2]>>16]>0)
				blockx=1;
		}
...
//y
	if (mob[i][5]!=0)
	{
		...
		{//iy>0
			...
			if (mpb[xx0[0]>>16][yy[1]>>16][zz0[0]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[1]>>16][yy[1]>>16][zz0[0]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[0]>>16][yy[1]>>16][zz0[1]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[1]>>16][yy[1]>>16][zz0[1]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[0]>>16][yy[1]>>16][zz0[2]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[1]>>16][yy[1]>>16][zz0[2]>>16]>0)
				blocky=1;
		}
		else
		{//iy<0
			if (yy[0]<0) blocky=1; else
			if (mpb[xx0[0]>>16][yy[0]>>16][zz0[0]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[1]>>16][yy[0]>>16][zz0[0]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[0]>>16][yy[0]>>16][zz0[1]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[1]>>16][yy[0]>>16][zz0[1]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[0]>>16][yy[0]>>16][zz0[2]>>16]>0)
				blocky=1;
			else
			if (mpb[xx0[1]>>16][yy[0]>>16][zz0[2]>>16]>0)
				blocky=1;
		}
