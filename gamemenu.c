...
void gamemenukey(void)
{
	...
	if (button[2]==1 || mousetap)
		if (configdata[mmsel]==0)
			...
			switch (mmsel)
			{
			case 0: zcplaysound(1);
				newgamemode=ZGM_GAMEPLAY;
				playmode=ZPM_AAA;
				LoadNewMap(1);
				break;                                                 //Training
			case 1: zcplaysound(12);
				newgamemode=ZGM_SELECTOR;
				break;                  //Campaing

			case 2: zcplaysound(12);
				newgamemode=ZGM_GAMEPLAY;
				playmode=ZPM_AUTISM;
				LoadNewMap(20);
				break;                                                      //Autism
			case 3: zcplaysound(12);
				newgamemode=ZGM_GAMEPLAY;
				playmode=ZPM_AAA;
				LoadNewMap(23);
				break;                                                   //extreme
			case 4: zcplaysound(12);
				newgamemode=ZGM_GAMEPLAY;
				playmode=ZPM_AAA;
				LoadNewMap(24);
				break;                                                   //zombie

			case 5: zcplaysound(1);
				newgamemode=ZGM_GAMEPLAY;
				playmode=ZPM_ZVERYLE;
				LoadNewMap(25);
				break;                                                      //zveryle

			case 6: zcplaysound(1);
				newgamemode=ZGM_CONFIG;
				break;

			case 7: zcplaysound(23);
				newgamemode=ZGM_GAMEPLAY;
				LoadNewMap(10);
				break;
			}
...
void menuconfigcontrol(void)
{
	...
	if (button[2]==1)
		...
		case 0: zcplaysound(1);
			...
			break;
#ifndef NOHAPTIC
		case 3: zcplaysound(1);
			configdata[10]=(configdata[10]+1)&1;
			break;
#endif
		case 4: zcplaysound(1);
